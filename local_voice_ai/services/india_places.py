...
# Native-script forms matter: Hindi/Punjabi viewers say cities in Devanagari/Gurmukhi.
_EXTRA_ALIASES: dict[str, tuple[str, ...]] = {
    "firozpur": (
        "ferozepur", "ferozpore", "ferozpur", "frostburt", "frostburg", "frostburn",
        "फिरोजपुर", "फिरोज़पुर", "ਫਿਰੋਜ਼ਪੁਰ", "ਫਿਰੋਜਪੁਰ",
    ),
    ...
    "punjab": ("पंजाब", "ਪੰਜਾਬ"),
    "delhi": ("new delhi", "ncr", "दिल्ली", "ਦਿੱਲੀ"),
    "new delhi": ("delhi", "ncr", "दिल्ली"),
    "mumbai": ("bombay", "मुंबई", "ਮੁੰਬਈ"),
